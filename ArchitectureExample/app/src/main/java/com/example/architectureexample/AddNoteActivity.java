...
public class AddNoteActivity extends AppCompatActivity {
    ...
    private NumberPicker numbrePickerPriority;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numbrePickerPriority = findViewById(R.id.number_picker_priority);

        numbrePickerPriority.setMaxValue(10);
        numbrePickerPriority.setMinValue(1);
    ...
    private void saveNote()
    {
        ...
        int priority = numbrePickerPriority.getValue();

        if(title.trim().isEmpty()||description.trim().isEmpty()){
            Toast.makeText(this,"insert a tite",Toast.LENGTH_SHORT).show();
            return;
        }
